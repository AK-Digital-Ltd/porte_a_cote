...
<tr>
    <td class="footer-container">
        ...
        <p class="footer-contact-info">
            1455 Boulevard Henri Barbusse, 13020 Bierre-l'Étang<br>
            <a href="#" class="footer-contact-link">conditions générales de
                vente</a><br><br>
            Si vous avez besoin d'aide, veuillez contacter le <strong>service après vente</strong><br>
            au <a href="tel:+33986563456" class="footer-contact-phone">(+33) 09 86 56 34 56</a> ou par mail : <a
                href="mailto:support@carole.com" class="footer-contact-email">support@carole.com</a>
        </p>
    </td>
</tr>
