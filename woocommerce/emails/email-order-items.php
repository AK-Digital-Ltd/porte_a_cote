...
<!-- Titre personnalisé "Vos produits" -->
<h2 style="margin-top: 30px; margin-bottom: 20px; color: #333; font-size: 18px; font-family: Arial, sans-serif;">Vos produits :</h2>
...
foreach ($items as $item_id => $item):
	...
	<tr class="<?php echo esc_attr(apply_filters('woocommerce_order_item_class', 'order_item', $item, $order)); ?>">
		<td class="td font-family text-align-left" style="vertical-align: middle; word-wrap:break-word; font-size: 12px;">
		...
		<td class="td font-family text-align-right" style="vertical-align:middle; font-size: 12px; padding-right: 10px; ">

		</td>
		<td class="td font-family text-align-<?php echo esc_attr($price_text_align); ?>"
...
<!-- Ligne de séparation après les produits -->


<!-- Nous avons supprimé le tableau de sous-total et de total -->